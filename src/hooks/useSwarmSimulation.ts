  ...
  const initialAgents: AgentEntity[] = [
    {
      ...
      maxBundleSize: 3,
      status: 'IDLE',
      health: { propulsion: 1.0, comms_transceiver: 1.0, comms: 1.0, gps: 1.0, battery: 98 },
      bundle: [],
      path: [],
      winningBids: {},
      winningAgents: {},
    ...
    },
    {
      ...
      maxBundleSize: 3,
      status: 'IDLE',
      health: { propulsion: 1.0, comms_transceiver: 1.0, comms: 1.0, gps: 1.0, battery: 92 },
      bundle: [],
      path: [],
      winningBids: {},
      winningAgents: {},
    ...
    },
    {
      ...
      maxBundleSize: 3,
      status: 'IDLE',
      health: { propulsion: 1.0, comms_transceiver: 1.0, comms: 1.0, gps: 1.0, battery: 89 },
      bundle: [],
      path: [],
      winningBids: {},
      winningAgents: {},
    ...
    },
    {
      ...
      maxBundleSize: 3,
      status: 'IDLE',
      health: { propulsion: 1.0, comms_transceiver: 1.0, comms: 1.0, gps: 1.0, battery: 94 },
      bundle: [],
      path: [],
      winningBids: {},
      winningAgents: {},
    ...
    },
    {
      ...
      maxBundleSize: 3,
      status: 'IDLE',
      health: { propulsion: 1.0, comms_transceiver: 1.0, comms: 1.0, gps: 1.0, battery: 99 },
      bundle: [],
      path: [],
      winningBids: {},
      winningAgents: {},
    ...
    },
    {
      ...
      maxBundleSize: 3,
      status: 'IDLE',
      health: { propulsion: 1.0, comms_transceiver: 1.0, comms: 1.0, gps: 1.0, battery: 96 },
      bundle: [],
      path: [],
      winningBids: {},
      winningAgents: {},
